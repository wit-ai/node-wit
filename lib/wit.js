...
function Wit(opts) {
  ...
  const {
    accessToken, apiVersion, handleMessage, headers, logger, witURL
...
const validate = (opts) => {
  ...
  opts.handleMessage = opts.handleMessage || defaultHandleMessage;

  return opts;
};

const defaultHandleMessage = ({entities}) => {
